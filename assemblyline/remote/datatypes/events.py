...
class EventSender(Generic[MessageType]):
    def __init__(self, prefix: str, host=None, port=None, private=None,
        ...
        self.client: Redis[Any] = get_pubsub_redis(host, port, private)
...
class EventWatcher(Generic[MessageType]):
    def __init__(self, host=None, port=None, private=None,
                 deserializer: Callable[[str], MessageType] = json.loads):
        client: Redis[Any] = get_pubsub_redis(host, port, private)
