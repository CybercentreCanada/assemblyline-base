...
class ResultSample(ServiceBase):
    ...
    SERVICE_REVISION = ServiceBase.parse_revision('$Id: ed4569799146e21e885fa3dc36e2e180774ba419 $')
    SERVICE_VERSION = '1'
    ...
    def execute(self, request):
        ...
        json_section = ResultSection(
            SCORE.NULL,
            'Example of a JSON section',
            self.SERVICE_CLASSIFICATION,
            body_format=TEXT_FORMAT.JSON,
            body={"a simple python": "dictionary", "a_list": ["a","b","c"]}
        )
