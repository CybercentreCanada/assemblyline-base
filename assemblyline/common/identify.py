...
STRONG_INDICATORS = {
    ...
    'document/email': [
        ...
        re.compile(rb'^X-MS-Exchange-Organization-ASDirectionalityType: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ATPCustomPipelineScanCompleteAction: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ATPDetonation-SonarData-ChunkCount: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ATPDetonationLatency: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ATPSafeLinks-UrlContainer-Data-ChunkCount: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-Antispam-ScanContext: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-AttachmentDetailsHeaderStamp-Success: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-AttachmentDetailsInfo-ChunkCount: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-CommunicationStateSummary: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-DelayAnalysis-Summary: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-ExpirationIntervalReason: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ExpirationStartTime: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ExpirationStartTimeReason: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ExtractionTagsFrom: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ExtractionTagsSubject: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ExtractionTagsSubjectNormalized: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-ExtractionTagsURLFound: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-HMATPModel-DkimAuthStatus: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-HMATPModel-DmarcAuthStatus: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-HMATPModel-Spf: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-HMATPModel-SpfAuthStatus: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-InternalOrgSender: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-IntraOrgSpoof-ImplicitAllowReason: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-Malware-OriginalScanContext: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-MessageDirectionality: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-OriginalClientIPAddress: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalServerIPAddress: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalSize: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalTenant-AuthAs: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalTenant-AuthSource: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalTenant-FromEntityHeader: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalTenant-Id: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalTenant-Network-Message-Id: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginalTenant-OriginalArrivalTime: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-Originating-Country: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OriginatorOrganization: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-OutboundCrossTenantAgentProcessed: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-PFAHub-Total-Message-Size: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-Persisted-Urls-ChunkCount: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-PersistedUrlCount: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-Processed-By-Gcc-Journaling: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-Recipient-Limit-Verified: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Organization-SafeAttachmentPolicy: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-SafeLinksPolicy: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-SenderRecipientCommunicationState: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-SenderRep-Score: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-SpoofDetection-ImplicitAllow: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-TargetResourceForest: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-TenantServiceProvider: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-TotalRecipientCount: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-Transport-Properties: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Organization-TransportTrafficType: ', re.MULTILINE),
        ...
        re.compile(rb'^X-MS-Exchange-Transport-CrossTenantHeadersPromoted: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Transport-CrossTenantHeadersStamped: ', re.MULTILINE),
        re.compile(rb'^X-MS-Exchange-Transport-CrossTenantHeadersStripped: ', re.MULTILINE),
