...
class File(odm.Model):
    ...
    is_supplementary = odm.Boolean(default=False, description="Is this a file generated by a service?", ai=False)
    ...
    label_categories = odm.Compound(LabelCategories, default={}, description="Categories of label", ai=False)
