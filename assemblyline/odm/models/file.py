...
class File(odm.Model):
    ...
    comments = odm.Optional(odm.List(odm.Compound(Comment), default=[], description="List of comments made on a file"))
    ...
    is_section_image = odm.Boolean(
        default=False, description="Is this an image from an Image Result Section?", ai=False)
    is_supplementary = odm.Optional(odm.Boolean(
        default=False, description="Is this a file generated by a service?", ai=False))
    hex = odm.Keyword(index=False, store=False, description="Hex dump of the first 64 bytes of the file", ai=False)
    labels = odm.Optional(odm.List(odm.Keyword(copyto="__text__"),
                          description="List of labels of the file", default=[]))
    label_categories = odm.Optional(odm.Compound(LabelCategories, default={},
                                    description="Categories of label", ai=False))
    md5 = odm.MD5(copyto="__text__", description="MD5 of the file", ai=False)
    ...
    seen = odm.Compound(Seen, default={}, description="Details about when the file was seen", ai=False)
    sha1 = odm.SHA1(copyto="__text__", description="SHA1 hash of the file", ai=False)
