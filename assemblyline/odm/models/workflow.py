...
class Workflow(odm.Model):
    classification = odm.Classification()               # Classification of the workflow
    ...
    label = odm.List(odm.Keyword())                     # Labels applied by the workflow
    last_edit = odm.Date()                              # Last edit date
    last_seen = odm.Date()                              # Last hit date
    name = odm.Keyword()                                # Name of the workflow
