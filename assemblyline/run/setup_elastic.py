...
if __name__ == "__main__":
    ...
    create_ilm_policy("apm-7.5.1-error", rollover_age="1d", rollover_size="5gb",
                      warm_readonly=True, delete_age=APM_DELETE_AFTER)
    create_ilm_policy("apm-7.5.1-metric", rollover_age="1d", rollover_size="5gb",
                      warm_readonly=True, delete_age=APM_DELETE_AFTER)
    create_ilm_policy("apm-7.5.1-span", rollover_age="1d", rollover_size="5gb",
                      warm_readonly=True, delete_age=APM_DELETE_AFTER)
    create_ilm_policy("apm-7.5.1-transaction", rollover_age="1d", rollover_size="5gb",
                      warm_readonly=True, delete_age=APM_DELETE_AFTER)

    # Setup filebeat ILM policies
    create_ilm_policy("filebeat-7.5.1", rollover_age="1d", rollover_size="20gb",
                      warm_readonly=True, delete_age=FILEBEAT_DELETE_AFTER)

    # Setup metricbeat ILM policies
    create_ilm_policy("metricbeat-7.5.1", rollover_age="1d", rollover_size="5gb",
