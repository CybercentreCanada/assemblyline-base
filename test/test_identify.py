...
@pytest.mark.parametrize(
    ...
    [
        ...
        (b"createobject(", ["code/vbs"]),
        (b".Run blah,0", ["code/vbs"]),
        (b".run blah,0", ["code/vbs"]),
        (b".Run blah,0,False", ["code/vbs"]),
        (b".Run blah,0,True", ["code/vbs"]),
        (b"Replace(\"blah\", \"blah\", \"blah\")", ["code/vbs"]),
        (b"replace(\"blah\", \"blah\", \"blah\")", ["code/vbs"]),
        (b"replace('blah', 'blah', 'blah')", ["code/vbs"]),
        (b"replace(blah, blah, blah)", ["code/vbs"]),
        (b"replace(blah, blah, '')", ["code/vbs"]),
        # JS
        ...
        (b"function(blah)\t{", ["code/javascript"]),
        (b"function(blah)\n{", ["code/javascript"]),
        (b"function(blah)\r{", ["code/javascript"]),
        (b"function(blah)\t\n\r{", ["code/javascript"]),
        ...
        (b"\n\tusing\tblah;", ["code/csharp"]),
        (b"\n\tusing\tstatic blah;", ["code/csharp"]),
        (b"\n\tusing\tstatic blah = blah<blah>;", ["code/csharp"]),
        ...
        (b"fixed (", ["code/csharp"]),
        (b"\n\t fixed\t(", ["code/csharp"]),
        (b"IsNullOrWhiteSpace(", ["code/csharp"]),
        # PHP
        (b"<?php", ["code/php"]),
        (b"\n<?php", ["code/php"]),
        (b"namespace blah", ["code/csharp", "code/php"]),
        ...
        (b"\nblah(b)\tthrows\tblah\t,\tblah\t{", ["code/java"]),
        (b"blah.hasNext(", ["code/java"]),
        (b"final blah", ["code/java"]),
        (b"final\tblah", ["code/java"]),
        (b"final\t blah", ["code/java"]),
        (b" \t\n final\t blah", ["code/java"]),
        (b"ArrayList<?", ["code/java"]),
        (b"ArrayList<String", ["code/java"]),
        (b"Class<String", ["code/java"]),
        (b"Stack<String", ["code/java"]),
        (b"Map<String", ["code/java"]),
        (b"Set<String", ["code/java"]),
        (b"HashSet<String", ["code/java"]),
        (b"PrivilegedAction<String", ["code/java"]),
        (b"Vector<String", ["code/java"]),
        # Perl
        (b"my $blah=", ["code/perl"]),
        (b"\n\tmy\t$blah\t=", ["code/perl"]),
        (b"\n my $blah =", ["code/perl"]),
        (b"\n my$blah =", []),
        (b"\n my $blah blah=", []),
        (b"sub blah{", ["code/vbs", "code/perl"]),
        (b"\n sub\tblah\t{", ["code/vbs", "code/perl"]),
        (b"\tsub blah {", ["code/vbs", "code/perl"]),
        (b"subblah{", []),
        # Ruby
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (b"WSH", ["code/javascript", "code/vbs"]),
        (b"wsh", ["code/vbs"]),
        (b"Set blah =", ["code/vbs", "code/batch"]),
        (b"set blah =", ["code/vbs", "code/batch"]),
        (b"Set\tblah\t=", ["code/vbs", "code/batch"]),
        (b"Set\tblah=", ["code/vbs", "code/batch"]),
        (b"Setblah=", []),
